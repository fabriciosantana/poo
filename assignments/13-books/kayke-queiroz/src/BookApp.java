...
public class BookApp {
    public static void main(String[] args) {
        ...
        PrintBook printBook = new PrintBook("1984", 1949, "George Orwell", "Companhia das Letras", "978-8535902774");
        AudioBook audioBook = new AudioBook("O Senhor dos Anéis", 1954, "J.R.R. Tolkien", 300.5, 1130, "Rob Inglis");
